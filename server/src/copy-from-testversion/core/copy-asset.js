...
const dataToCopy = require('../data-to-copy/metadrob-test.assets.json')
...
// mongoimport --uri="mongodb://admin:admin@metadrob.com:17017/Metadrob?authSource=Metadrob&readPreference=primary&appname=MongoDB%20Compass%20Community&ssl=false" --db=Metadrob --collection=assets --mode=upsert --type=json --jsonArray --file="C:\PROJECT\Metadrob shopify\metadrob\server\src\copy-from-testversion\data-to-copy\metadrob-test.assets.json"

// except Tutorial video
