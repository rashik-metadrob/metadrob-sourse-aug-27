...
import { getListPlayers } from "../../../../../redux/modelSlice";
...
const Element = ({
    ...
    const listPlayers = useSelector(getListPlayers)
    ...
    const isMute = () => {
        return !!listPlayers.find(el => el.id === playerId && (el.mute || el.beMuted) )
    }
...
export default React.memo(Element, areEqual)