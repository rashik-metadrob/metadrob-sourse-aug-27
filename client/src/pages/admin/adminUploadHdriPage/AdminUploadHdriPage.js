...
import AdminUploadHdriForm from "../../../components/adminComponents/adminUploadHdriForm/AdminUploadHdriForm";
import { isShopifyAdminLocation } from "../../../utils/util";
import routesConstant from "../../../routes/routesConstant";

const AdminUploadHdriPage = () => {
    ...
    const onBack = () => {
        if(isShopifyAdminLocation(location)) {
            navigate(routesConstant.shopifyAdminUploadHdri.path)
        } else {
            navigate(routesConstant.adminUploadHdri.path)
        }
    }

    return <>
        <Row gutter={[26, 26]} className="!ml-0 !mr-0 mt-[38px] px-[31px] admin-upload-hdri-page-container mb-[120px]">
...
export default AdminUploadHdriPage;